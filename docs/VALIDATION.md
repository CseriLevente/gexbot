...
|---|---|---|---|
| Package version | `2.1.3` | `pyproject.toml` | anything ships |
| Parser version | `thetadata-v3-parser/2.1.3` | `src/adapters/raw_store.py` | vendor-payload interpretation changes |
| Engine version | `gex-engine/2.1.3` | `src/domain/model_spec.py` | the numerics change |
