...
|---|---|---|---|
| Package version | `2.1.26` | `pyproject.toml` | anything ships |
...
| Capture-certification schema | `capture-certification/2.1.26` | `src/adapters/thetadata/capture_certification.py` | what an offline certification report derives from a capture changes |
